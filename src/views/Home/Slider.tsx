  ...
  return (
    <div>
      ...
      <div className='relative z-30 container'>
          <form onSubmit={(e) => e.preventDefault()} className="absolute w-full mx-auto translate-x-1/4 -translate-y-1/2">
            <div className="flex items-center border-orange-950 border-400 py-2">
              ...
              />
              <button
              className={`appearance-none block bg-[#FFFFFF] w-1/3 text-gray-700 rounded-xl py-3 px-12 mb-3 border-20 border-orange-900 numberCustomer item-button ${isItemVisible ? 'active' : ''}`}
              type="button"
              onClick={toggleItemVisibility}
              >
                <div className="box-title-user flex items-center">
                <i className="fa fa-users pr-10 pl-2"></i>
                <span className="count-people count-adult">{adultCount === 0 ? "0" : adultCount} </span> người lớn, {""}
                <span className="count-people count-child"> {childCount === 0 ? "0" : childCount} </span> trẻ em,{""}
                <span className="count-people count-infant"> {infantCount === 0 ? "0" : infantCount} </span> em bé{""}
                                ...
                                <td>
                                    <div className="box-people type-adult">
                                        ...
                                        <div className="btn-group flex items-center" role="group">
                                            <button type="button" className="type-button type-minus "
                                            onClick={() => handleDecrement('adult')}
                                            >{""}<i className="fa-solid fa-minus"></i></button>

                                            <span className="btn-value btn-value-adult" >{adultCount === 0 ? "0" : adultCount}</span> 

                                            <button className="button type-button type-plus"
                                ...
                                <td>
                                    <div className="box-people type-child">
                                        ...
                                        <div className="btn-group flex items-center" role="group">
                                            ...
                                            <span className="btn-value btn-value-child">{childCount === 0 ? "0" : childCount}</span>

                                            <button type="button" className="type-button type-plus"
                                ...
                                <td>
                                    <div className="box-people type-infant">
                                        ...
                                        <div className="btn-group flex items-center" role="group">
                                            ...
                                            <span className="btn-value btn-value-infant">{infantCount === 0 ? "0" : infantCount}</span>
              ...
              <button className="bg-teal-500 border-orange-900 text-sm border-20 text-[#FFFFFF] mb-2.5 py-4 px-4 rounded bg-[#3399FF] font-bold text-center item-button" 
                type="button"
              >
                Tìm kiếm
              </button>
