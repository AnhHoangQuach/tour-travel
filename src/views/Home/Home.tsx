...
const Home = () => {
  ...
  const [selectedTour, setSelectedTour] = useState({ place: '' });

  const handleTourClick = (place: string): void => {
    const tourInfo: TourInfo = {
      place: place,
    };

    setSelectedTour(tourInfo);
    // Assuming openModal is a function you have defined somewhere
    openModal();
  };
      ...
      <Container maxWidth='lg' className='px-4 lg:p-0'>
        ...
        <Grid className='mb-8' container spacing={4}>
          <Grid item xs={12} sm={3} >
            ...
            onClick={() => handleTourClick('Sapa - 3N2D')}>
              <div
                style={{
          ...
          <Grid item xs={12} sm={3} >
            <div className='relative overflow-hidden hover:bg-center'
            onClick={() => handleTourClick('Quảng Bình- 4N3D')}>
              <div
                style={{
                ...
                <div className='translate-y-10'>
                  ...
                  <p className='py-2 text-sm'>
                    <span className='text-[#FFFFFF]'>4N3D</span>
                    <span className='text-[#FFFFFF]'> - 9,2 triệu / người</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <Grid item xs={12} sm={3} >
            <div className='relative overflow-hidden hover:bg-center'
            onClick={() => handleTourClick('Đà Lạt - 3N2D')}>
              <div
                style={{
                  backgroundImage: `url(https://mauweb.monamedia.net/lets-travel/wp-content/uploads/2018/12/dalat.jpg)`,
                  transition: 'transform 0.5s',
                }}
                className='py-12 pl-3 rounded-xl bg-center bg-no-repeat bg-cover font-bold text-[#FFF] transform scale-95 hover:scale-100'
                >
                <div className='translate-y-10'>
                  <p className='text-xl font-bold' data-value="place">Đà Lạt</p>
                  <p className='py-2 text-sm'>
                    <span className='text-[#FFFFFF]'>3N2D</span>
                    <span className='text-[#FFFFFF]'> - 5 triệu / người</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <Grid item xs={12} sm={3} >
            <div className='relative overflow-hidden hover:bg-center'
            onClick={() => handleTourClick('Hồ Chí Minh - 7N7D')}>
              <div
                style={{
                ...
                >
                <div className='translate-y-10'>
                  <p className='text-xl font-bold' data-value="place">Hồ Chí Minh</p>
                  <p className='py-2 text-sm'>
                    <span className='text-[#FFFFFF]'>7N7D</span>
                    <span className='text-[#FFFFFF]'> - 10 triệu / người</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <Grid item xs={12} sm={3} >
            <div className='relative overflow-hidden hover:bg-center'
            onClick={() => handleTourClick('Cần thơ - 4N3D')}>
              <div
                style={{
                ...
                >
                <div className='translate-y-10'>
                  <p className='text-xl font-bold' data-value="place">Cần thơ</p>
                  <p className='py-2 text-sm'>
                    <span className='text-[#FFFFFF]'>4N3D</span>
                    <span className='text-[#FFFFFF]'> - 6,5 triệu / người</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 md:p-5">
                <form className="space-y-4" action="#">
                    ...
                    <div>
                        ...
                        <input type="text" 
                        value={`Place: ${selectedTour.place}`}
