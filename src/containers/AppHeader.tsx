...
const AppHeader = () => {
  ...
  const handleRegister = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      console.log('Regsiter success', data);
      window.location.reload(); // Tải lại trang để cập nhật trạng thái đăng nhập
    } catch (error: any) {
      const resMessage =
        (error.response &&
              ...
              <div className="relative">
                ...
                <div className="p-4 md:p-5">
                    <form className="space-y-4" action="#">
                        ...
                        <button type="submit" 
                          className="w-1/4 ml-40 text-center bg-[#00FFFF] hover:bg-[#FF0000] border-3 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                          onClick={handleLogin}
